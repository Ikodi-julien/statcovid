...
class __TwigTemplate_b253def9ef6330204375e09e82c3735c75f6fff6dffb53607507aface669d66a extends Template
{
    private $source;
    private $macros = [];
...
$context["voter_detail"]) && is_array($__internal_compile_5) || $__internal_compile_5 instanceof ArrayAccess ? ($__internal_compile_5["vote"] ?? null) : null), twig_constant("Symfony\\Component\\Security\\Core\\Authorization\\Voter\\VoterInterface::ACCESS_DENIED")))) {
    ...
    {
        return new Source("", "@Security/Collector/security.html.twig", "/var/www/project/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
